...
(* OASIS_START *)
(* DO NOT EDIT (digest: 905d494eba624af787e23f81648be118) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_hoquet", []))];
     ...
     package =
       {
          ...
          homepage = None;
          synopsis =
            "HTML templating directly in OCaml in the style of Elm HTML and\nHiccup in Clojure";
          description = None;
          categories = [];
               ...
               Test
                 ({
                  ...
                  },
                   {
                      ...
                      test_tools = [InternalExecutable "test_hoquet"]
                   })
            ];
          plugins =
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\031\128\167\211\159q\t\134=\158&f\170\239\156\213";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
